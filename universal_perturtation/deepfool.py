...
def deepfool(image, f, grads, num_classes=10, overshoot=0.02, max_iter=50):
    ...
    I = (np.array(f_image)).flatten().argsort()[::-1] #x.argsort()将x中的元素从小到大排列并提出其索引输出，[::-1]表示从头到尾将数组反转，反转后变成从大到小排列
    ...
    while k_i == label and loop_i < max_iter:
        ...
        for k in range(1, num_classes):
            ...
            w_k = gradients[k, :, :, :, :] - gradients[0, :, :, :, :]   #更新w_k
            f_k = f_i[I[k]] - f_i[I[0]]     #更新f_k
